...
class TestModel(unittest.TestCase):
    ...
    def test_serialize_deser(self):
        json_sparse = '{"class_name": "ExtendedModel", "config": {"name": "extendedmodel_1", "layers": [{"name": "input_1", "class_name": "InputLayer", "config": {"batch_input_shape": [null, 28, 28, 1], "dtype": "float32", "sparse": false, "name": "input_1"}, "inbound_nodes": []}, {"name": "r_proj_conv2d_1", "class_name": "RProjConv2D", "config": {"offset_creator_id": "sparse", "filters": 8, "kernel_size": [3, 3], "strides": [1, 1], "padding": "valid", "data_format": "channels_last", "activation": "relu", "use_bias": true, "kernel_initializer": {"class_name": "VarianceScaling", "config": {"scale": 2.0, "mode": "fan_in", "distribution": "normal", "seed": null}}, "bias_initializer": {"class_name": "Zeros", "config": {}}, "kernel_regularizer": {"class_name": "L1L2", "config": {"l1": 0.0, "l2": 0.0}}, "bias_regularizer": null, "activity_regularizer": null, "kernel_constraint": null, "bias_constraint": null}, "inbound_nodes": [[["input_1", 0, 0, {}]]]}, {"name": "r_proj_conv2d_2", "class_name": "RProjConv2D", "config": {"offset_creator_id": "sparse", "filters": 4, "kernel_size": [3, 3], "strides": [1, 1], "padding": "valid", "data_format": "channels_last", "activation": "relu", "use_bias": true, "kernel_initializer": {"class_name": "VarianceScaling", "config": {"scale": 2.0, "mode": "fan_in", "distribution": "normal", "seed": null}}, "bias_initializer": {"class_name": "Zeros", "config": {}}, "kernel_regularizer": {"class_name": "L1L2", "config": {"l1": 0.0, "l2": 0.0}}, "bias_regularizer": null, "activity_regularizer": null, "kernel_constraint": null, "bias_constraint": null}, "inbound_nodes": [[["r_proj_conv2d_1", 0, 0, {}]]]}, {"name": "max_pooling2d_1", "class_name": "MaxPooling2D", "config": {"name": "max_pooling2d_1", "trainable": true, "dtype": "float32", "pool_size": [2, 2], "padding": "valid", "strides": [2, 2], "data_format": "channels_last"}, "inbound_nodes": [[["r_proj_conv2d_2", 0, 0, {}]]]}, {"name": "flatten_1", "class_name": "Flatten", "config": {"name": "flatten_1", "trainable": true, "dtype": "float32", "data_format": "channels_last"}, "inbound_nodes": [[["max_pooling2d_1", 0, 0, {}]]]}, {"name": "r_proj_dense_1", "class_name": "RProjDense", "config": {"name": "r_proj_dense_1", "trainable": true, "dtype": "float32", "offset_creator_id": "sparse", "units": 32}, "inbound_nodes": [[["flatten_1", 0, 0, {}]]]}, {"name": "r_proj_dense_2", "class_name": "RProjDense", "config": {"name": "r_proj_dense_2", "trainable": true, "dtype": "float32", "offset_creator_id": "sparse", "units": 10}, "inbound_nodes": [[["r_proj_dense_1", 0, 0, {}]]]}], "input_layers": [["input_1", 0, 0]], "output_layers": [["r_proj_dense_2", 0, 0]], "vsize": 200}, "keras_version": "2.3.1", "backend": "tensorflow"}'
    ...
    # json = self.global_model.model.to_json()
    #     print(json_dense)
    #     existing_weights = self.global_model.model.get_all_weights()
    #     tf.reset_default_graph()
        ...
        with keras.backend.get_session() as sess:
            ...
            # n.set_all_weights(existing_weights)
            self.local_model.set_model(n)
            weights = self.local_model.model.get_all_weights()


            self.local_model.setup_new_round(1, n.get_weights())
            self.local_model.train_one_round()
            # self.local_model.train_one_round()
            path = os.path.join(module_loc, "test")
            print(path)
