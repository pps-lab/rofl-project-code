...
use fixed::{FixedI8, FixedI16, FixedI32, FixedI64, FixedU8, FixedU16, FixedU32, FixedU64};
use fixed::frac::{U0, U1, U2, U3, U4, U5, U6, U7, U8, U9, U10, U11, U12};
...
mod fp_config{
    ...
    pub type IRawFix = i8;
    pub type URawFix = u8;
    pub fn read_from_bytes(x: &[u8]) -> u8 {*x.first().unwrap()}
...
mod fp_config{
    ...
    pub fn read_from_bytes(x: &[u8]) -> u16 {LittleEndian::read_u16(x)}
...
mod fp_config{
    ...
    pub fn read_from_bytes(x: &[u8]) -> u32 {LittleEndian::read_u32(x)}
...
mod fp_config{
    ...
    pub fn read_from_bytes(x: &[u8]) -> u64 {LittleEndian::read_u64(x)}
...
mod fp_config{  //default default fixed precision
    use super::*;
    pub const N_BITS: usize = 32;
    pub type Fix = FixedU32<Frac>;
    pub type IRawFix = i32;
