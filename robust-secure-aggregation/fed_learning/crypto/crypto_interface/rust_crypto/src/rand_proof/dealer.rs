...
impl<'a, 'b> DealerAwaitingCommitment<'a, 'b> {
    pub fn receive_commitment(self, c_prime: ElGamalPair) -> Result<(DealerAwaitingChallengeResponse<'a, 'b>, Scalar), ProofError> {
...
impl<'a, 'b> DealerAwaitingChallengeResponse<'a, 'b> {
    pub fn receive_challenge_response(self, z_m: Scalar, z_r: Scalar) -> Result<RandProof, ProofError> {
