...
use rofl_crypto::bench_constants::{RANGE, N_PARTITION, DIM, num_samples};
...
benchmark_group!(benchmark_rangeproof_bench, bench_rangeproof_fn);
benchmark_main!(benchmark_rangeproof_bench);
